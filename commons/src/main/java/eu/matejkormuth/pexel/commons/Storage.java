...
public interface Storage {
    ...
    public abstract Collection<MinigameDescriptor> getAvaiablePlugins();
    
    public abstract Collection<MapDescriptor> getAvaiableMaps();
    
    public abstract boolean hasPlugin(String pluginName);
