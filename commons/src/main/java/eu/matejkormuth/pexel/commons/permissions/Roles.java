...
public class Roles {
     ...
     */
    public static final Role                 ADMIN   = new Role("pexel.admin",
                                                             Roles.DEFAULT,
                                                             Permissions.KICK,
                                                             Permissions.BAN_IP,
     ...
     */
    public static final Role                 OWNER   = new Role("pexel.owner",
                                                             Roles.ADMIN,
                                                             Permissions.SPECIAL_ALL);
    
    protected static final Map<String, Role> mapping = Maps.newHashMap();
