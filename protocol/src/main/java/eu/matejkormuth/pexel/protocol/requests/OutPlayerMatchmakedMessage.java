 ...
 * 
 */
public class OutPlayerMatchmakedMessage extends Request {
    public UUID playerId;
    public UUID gameId;
    public long createdAt;
    
    public OutPlayerMatchmakedMessage() {
        this.createdAt = System.currentTimeMillis();
    }
    
    public OutPlayerMatchmakedMessage(final ProxiedPlayer player, final UUID gameId) {
