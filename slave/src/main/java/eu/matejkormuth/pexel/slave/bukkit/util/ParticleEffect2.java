...
import eu.matejkormuth.pexel.slave.bukkit.util.ReflectionHandler.PackageType;
import eu.matejkormuth.pexel.slave.bukkit.util.ReflectionHandler.SubPackageType;
    ...
    static {
        ...
        try {
            packetPlayOutWorldParticles = ReflectionHandler.getConstructor(
                    eu.matejkormuth.pexel.slave.bukkit.util.ReflectionHandler.PacketType.PLAY_OUT_WORLD_PARTICLES.getPacket(),
