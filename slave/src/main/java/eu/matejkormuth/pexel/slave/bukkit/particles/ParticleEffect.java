package eu.matejkormuth.pexel.slave.bukkit.particles;
...
import eu.matejkormuth.pexel.slave.bukkit.ReflectionUtils;
import eu.matejkormuth.pexel.slave.bukkit.ReflectionUtils.PackageType;
    ...
    public static final class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                sendPacket = ReflectionUtils.getMethod(playerConnection.getType(),
        ...
        public void sendTo(final Location center, final Player player)
            ...
            if (this.packet == null) {
                try {
                    ...
                    if (version > 7) {
                        ReflectionUtils.setValue(this.packet, true, "j",
                                this.longDistance);
